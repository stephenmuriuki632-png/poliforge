        ...
        <form className="mt-10 space-y-7">
          ...
          <div>
            ...
            <select className="mt-3 w-full rounded-2xl border border-white/10 bg-[#0b0b0b] px-4 py-4 text-sm text-white outline-none focus:border-white/30">
              <option value="">Select a campaign video</option>
          ...
          <div className="rounded-3xl border border-white/10 bg-white/[0.02] p-6">
            ...
            <p className="mt-2 text-xs leading-5 text-white/30">
              Set the amount a clipper receives for each approved clip.
            </p>
            ...
            <div className="mt-5 flex items-center gap-3">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm outline-none focus:border-white/30"
              />
            </div>
          </div>
          ...
          <div className="rounded-2xl border border-white/10 bg-white/[0.02] p-5">
            ...
            <p className="mt-2 text-xs leading-5 text-white/30">
              ...
              once it is published. You can review submitted clips
